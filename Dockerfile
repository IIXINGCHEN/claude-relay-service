# 🐳 Claude Relay Service - Unified Dockerfile
# Supports both standard and offline deployment with build args
...
# 🔽 安装依赖 (生产环境)
# NPM_REGISTRY can be overridden for offline/accelerated builds
ARG NPM_REGISTRY
